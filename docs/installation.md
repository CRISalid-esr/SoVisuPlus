...
| HAL_ENDPOINT                              | Base HAL API URL (defaults to `https://api.archives-ouvertes.fr`); the SWORD client appends `/sword/hal/`, the reference-data scripts append `/ref/...`                                                                       | n       | server          | y                  | prod                                   | n                  |
