...
| NEXT_PUBLIC_CRISALID_AGENTS_API_URL       | Base URL of the Crisalid Agents API backing the AI chat assistant. The chat widget is only displayed when this variable is set and non-empty.                                                                               | n       | client          | y                  | prod                                   | n                  |
