...
1. `preferred_username` — the local username. If it looks like an EPPN (`jdupont@my-univ.fr`), the domain part is stripped. Matched as a `PersonIdentifierType.local` identifier.
