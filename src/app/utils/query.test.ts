...
interface OrganizationsByNameQuery extends BaseQuery {
  searchLang: string
}
...
describe('toQueryString utility', () => {
  ...
  it('should convert OrganizationsByNameQuery to a query string', () => {
    const researchQuery: OrganizationsByNameQuery = {
      searchTerm: 'example',
      searchLang: 'en',
      page: 2,
    }
