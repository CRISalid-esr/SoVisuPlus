        ...
        setAlert({
          ...
          message: (
            <TransNode
              ...
              values={{
                isSingle:
                  values.length == 1 && oldNumber == 1 ? 'true' : 'false',
                field: field.value as DocumentLocalizableFieldKey,
              }}
            />
          ),
        })
      ...
      setAlert({
        ...
        message: (
          <TransNode
            id='bibliographic_information_update_success'
            values={{
              isSingle: values.length == 1 && oldNumber == 1 ? 'true' : 'false',
              field: field.value as DocumentLocalizableFieldKey,
            }}
          />
        ),
