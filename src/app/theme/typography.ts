...
const letterSpacing = {
  ...
  'letterSpacing0.10': pxToRem(0.1), // "0.00625rem", 0.10px
...
export const figmaTypography = {
  fontFamily:
    'Roboto, Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif',
  fontWeight,
  heading: {
    h1: {
