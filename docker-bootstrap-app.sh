...
cat <<EOF >> .env
NEXT_PUBLIC_BASE_URL=${BASE_URL:-http://sovisuplus.local:3000}
NEXT_PUBLIC_WS_SCHEME=${WS_SCHEME:-ws}
NEXT_PUBLIC_WS_HOST=${WS_HOST:-localhost}
NEXT_PUBLIC_WS_PORT=${WS_PORT:-3001}
NEXT_PUBLIC_WS_PATH=${WS_PATH:-/}
...
KEYCLOAK_PUBLIC_URL=${KEYCLOAK_PUBLIC_URL:-http://keycloak.local:8080}/realms/${KEYCLOAK_REALM:-}
NEXTAUTH_URL=${NEXTAUTH_URL:-http://sovisuplus.local:3000}/api/auth
...
NEXT_CAS_CLIENT_SAML_TOLERANCE=${CAS_CLIENT_SAML_TOLERANCE:-18000}
NEXT_CAS_CLIENT_SECRET="${CAS_CLIENT_SECRET:-xxxxxx32carscasclientsecretxxxxx}"
