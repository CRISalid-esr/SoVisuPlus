...
| Date          | Date                      | Yes      | Label is context-sensitive: "Date de publication" (ART/OUV/COUV), "Date de soutenance" (THESE/HDR), "Date de début du congrès" (COMM/POSTER/PRESCONF). Pre-populated from `document.publicationDate`.                                                |
